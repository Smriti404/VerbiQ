...
export const PROFICIENCY_LEVELS = ["Beginner", "Intermediate", "Advanced", "Fluent"];
...
export const TIMEZONES = [
  ...
  { value: "UTC+08:00", label: "UTC+08:00 (SGT)" },
...
export const AVAILABILITY_TIMES = ["Morning", "Afternoon", "Evening", "Late Night"];
